...
public class FormViewJustActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Query postsQuery = FirebaseDatabase.getInstance().getReference().child("formularios_justificados");
                ...
                AuthUI.getInstance()
                        ...
                        .addOnCompleteListener(new OnCompleteListener<Void>() {
                            public void onComplete(@NonNull Task<Void> task) {
                                startActivity(new Intent(FormViewJustActivity.this, SignInActivity.class));
                                finish();
                            }
                        });
        }
